	...
	public StaffSchedules(String name, int idNumber, String department, String position ,String shift, String staffSchedule)
{
	...
	public void checkStaffSchedule()
	{
		...
		try {
			...
			case "RECEPTIONIST" :
				System.out.println("This position works day shift. \n" + "Schedule is Monday to Friday, 7:00 AM - 3:30 PM\n");
			...
			case "LEASING" :
				System.out.println("LEASING works day shift, Monday to Saturday, 7:00 AM - 3:30 PM");
			...
			case "MAINTENANCE" :
				System.out.println("MAINTENANCE works day shift, Monday to Friday, 7:00 AM - 3:30 PM\n" + "On-call weekends");
    ...
    /**
     * showPositionsMenu shows positions menu. 
     * Void showPositionsMenu method
     */
